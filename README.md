# Here is a collection of Deep Learning Resources
### With time I have tried to bring more and more content to this page, reach out to me if you want something specific and isn't in this repo, I will try my best to locate that resource for you.
...
-----
### Contributing
Have anything in mind that you think is awesome and would fit in this list? Feel free to send a [pull request](https://github.com/aravind-naidu/deeplearning-database/pulls). 

----

### License
This repository is a collection of data from a lots of sources, webpages and repositories. It is not just wrong to put it under my name's license but also, controls the usage and growth. The repository is free to use, modify and copy. I would love if you just fork my repo when you use it. And, add a pull request to add more resources. Keep this growing!!!

You can find me at [Aravind Naidu on LinkedIn](www.linkedin.com/in/aravind-naidu)
